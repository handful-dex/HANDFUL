...
DEFAULT_INACTIVE_FINGER_INDICES = [[0, 1, 2, 3]]  # Empty - all fingers active for pressing
...
@register_env("xArm7-v1-press-button-whole-hand", max_episode_steps=100)
class XArm7TableTopPressWholeHand(BaseEnv):
