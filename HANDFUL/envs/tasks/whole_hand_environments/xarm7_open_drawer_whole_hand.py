...
@register_env("xArm7-v1-cabinet-drawer-whole-hand", max_episode_steps=MAX_EPISODE_STEPS)
class XArm7CabinetDrawerWholeHand(BaseEnv):
    SUPPORTED_ROBOTS = [
...
@register_env("xArm7-v1-cabinet-door-whole-hand", max_episode_steps=MAX_EPISODE_STEPS)
class XArm7CabinetDoorWholeHand(XArm7CabinetDrawerWholeHand):
