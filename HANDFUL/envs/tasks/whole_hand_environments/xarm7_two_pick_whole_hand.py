...
@register_env("xArm7-v1-two-pick-whole-hand", max_episode_steps=100)
class XArm7TableTopTwoPickWholeHand(BaseEnv):
    ...
    def __init__(self, *args, state_file_path: str = "intermediate_states/xArm7-v1-pick-all__train__9__1771746645/grasp_to_push_img.pt",  **kwargs):
