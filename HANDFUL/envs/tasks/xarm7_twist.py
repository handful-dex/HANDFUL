...
DEFAULT_ACTIVE_FINGER_INDICES = [[1, 2]]
DEFAULT_INACTIVE_FINGER_INDICES = [[0, 3]]
...
@register_env("xArm7-v1-knob-twist", max_episode_steps=MAX_EPISODE_STEPS)
class XArm7TableTopKnobTwist(BaseEnv):
